	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 break26_g6 = uv_MainTex;
				float GlobalTilingX281 = ( _TilingX - 1.0 );
				float GlobalTilingY282 = ( _TilingY - 1.0 );
				float2 appendResult14_g6 = (float2(( break26_g6.x * GlobalTilingX281 ) , ( break26_g6.y * GlobalTilingY282 )));
				float GlobalOffsetX493 = _OffsetX;
				float GlobalOffsetY496 = _OffsetY;
				float2 appendResult13_g6 = (float2(( break26_g6.x + GlobalOffsetX493 ) , ( break26_g6.y + GlobalOffsetY496 )));
				...
				float2 break26_g11 = uv_BumpMap;
				float2 appendResult14_g11 = (float2(( break26_g11.x * GlobalTilingX281 ) , ( break26_g11.y * GlobalTilingY282 )));
				float2 appendResult13_g11 = (float2(( break26_g11.x + GlobalOffsetX493 ) , ( break26_g11.y + GlobalOffsetY496 )));
				float3 unpack2 = UnpackNormalScale( tex2D( _BumpMap, ( appendResult14_g11 + appendResult13_g11 ) ), _BumpScale );
				...
				float2 break26_g7 = uv_MetallicGlossMap;
				float2 appendResult14_g7 = (float2(( break26_g7.x * GlobalTilingX281 ) , ( break26_g7.y * GlobalTilingY282 )));
				float2 appendResult13_g7 = (float2(( break26_g7.x + GlobalOffsetX493 ) , ( break26_g7.y + GlobalOffsetY496 )));
				...
				float2 break26_g12 = uv_OcclusionMap;
				float2 appendResult14_g12 = (float2(( break26_g12.x * GlobalTilingX281 ) , ( break26_g12.y * GlobalTilingY282 )));
				float2 appendResult13_g12 = (float2(( break26_g12.x + GlobalOffsetX493 ) , ( break26_g12.y + GlobalOffsetY496 )));
				float blendOpSrc136 = tex2D( _OcclusionMap, ( appendResult14_g12 + appendResult13_g12 ) ).r;
				...
				float fresnelNode25 = ( lerpResult68 + _PowerFalloffOpacity * pow( max( 1.0 - fresnelNdotV25 , 0.0001 ), (( 1.0 + -_Opacity ) + (1.0 - 0.0) * (_Opacity - ( 1.0 + -_Opacity )) / (1.0 - 0.0)) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float clampResult45 = clamp( (( _Invert )?( ( 1.0 - fresnelNode25 ) ):( fresnelNode25 )) , 0.0 , 1.0 );
				float AlbedoA250 = tex2DNode76.a;
				float2 uv_MetallicGlossMap = IN.ase_texcoord2.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float2 break26_g7 = uv_MetallicGlossMap;
				float2 appendResult14_g7 = (float2(( break26_g7.x * GlobalTilingX281 ) , ( break26_g7.y * GlobalTilingY282 )));
				float2 appendResult13_g7 = (float2(( break26_g7.x + GlobalOffsetX493 ) , ( break26_g7.y + GlobalOffsetY496 )));
				float4 tex2DNode123 = tex2D( _MetallicGlossMap, ( appendResult14_g7 + appendResult13_g7 ) );
